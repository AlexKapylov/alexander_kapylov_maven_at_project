...
//        new MyHttpClient().httpGet();
        new MyHttpClient().search(new Search("a",true));
    }

    public void httpGet() throws IOException, URISyntaxException, ParseException {
    ...
    public void search(Search search) throws URISyntaxException, IOException, ParseException {
        ...
        request.setEntity(new StringEntity(new ParserJSON().fromGSON(search)));
